clear;clc;
%list of images
imglist=importdata('undetected.txt');
%minimum size of face
minsize=15;

%path of toolbox
caffe_path='/home/chen/caffe/matlab';
...
% 	img=imread(imglist{i});
    img=imread('/home/chen/face-alignment/faceDataset/Multi-PIE/data/240/068_04_02_240_05.png');
